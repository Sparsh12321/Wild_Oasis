    ...
    <StyledSalesChart>
      ...
      <ResponsiveContainer height={300} width="100%">
        <AreaChart data={data}>
          ...
          <Area name="Total Sales" strokeWidth={5} dataKey="totalSales" type="monotone" stroke={colors.totalSales.stroke} fill={colors.totalSales.fill} unit="$" />
          <Area name="Total Sales" strokeWidth={5} dataKey="extrasSales" type="monotone" stroke={colors.extrasSales.stroke} fill={colors.extrasSales.fill} unit="$" />
        </AreaChart>
      </ResponsiveContainer >
    </StyledSalesChart >
  );
