...
function Menus({ children }) {
  ...
  return <MenusContext.Provider value={{ position, setPosition, openId, close, open }}>{children}</MenusContext.Provider>;
}
...
function Toggle({ id }) {
  ...
  function handleClick(e) {
    ...
    setPosition({ x: window.innerWidth - rec.width - rec.x, y: 8 + rec.height + rec.y });
  }
